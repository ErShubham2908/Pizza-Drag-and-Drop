...
function dragstarts(event) {
    ...
    document.querySelector('.pizza-plate').classList.add('drag');
}
...
function drop() {
    ...
    document.querySelector('.pizza-plate').innerHTML = '';
    document.querySelector('.pizza-plate').appendChild(img);
    topings();
}
...
function topings() {
    let container = document.querySelector(".pizza-top-base")
